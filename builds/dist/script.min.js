...
$(document).ready(function(){$(window).scroll(function(){$(window).scrollTop()>40?$("nav").addClass("navbar-dark"):$("nav").removeClass("navbar-dark")})});